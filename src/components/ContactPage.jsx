...
<Helmet>
      ...
      <div className='bg-gradient-to-tr from-[#fbf4f4]  to-[white]  '>

      <div className='bg-gradient-to-r from-orange-400 to-red-500 md:py-16 py-10'>
      <h1 className='md:text-5xl text-4xl font-bold text-center text-white tracking-widest '>Feel Free to Contact Us
      </h1>
...
{/* <MapContainer center={position} zoom={15} style={{ height: '400px', width: '100%' }}>
      ...
      <div className='allformhere flex flex-col md:flex-row md:px-36 md:py-10 md:space-x-5 px-4 py-5'>
        ...
        <div className='p-2 md:w-[60%] w-full flexflex-col'>
          <h1 className='md:text-4xl text-3xl font-semibold tracking-wider mb-5 md:ml-2  md:text-start text-center'>Get in Touch</h1>
          <div className=''>
          {/* <CustomAlert
        message={status}
        show={showAlert}
...
{/* <form > */}
  ...
  className="placeholder-slate-300 form-control md:py-3 md:px-6 px-2 py-2 rounded-md focus:outline-none text-md inline-block outline outline-1 outline-slate-300 placeholder:text-base"
...
<input
  ...
  className="placeholder-slate-300 form-control md:py-3 py-2 px-2 md:px-6 rounded-md focus:outline-none text-md inline-block outline outline-1 outline-slate-300 placeholder:text-base"
...
/>
    ...
    className="placeholder-slate-300 form-control py-3 px-6 rounded-md focus:outline-none text-md col-span-2 inline-block outline outline-1 placeholder:text-base outline-slate-300"  placeholder='Enter your Subject' required />

    <textarea required name="" id="" className='focus:outline-none 
...
{(!verificationHelp) ? (
        ...
        disabled={loadingSubmit}
          ...
          className={`px-14 py-4 mt-5 text-white rounded-lg flex justify-center items-center ${
            loadingSubmit ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
          }`}
        >
           {loadingSubmit ? (
            <svg
      ...
      className={`w-full mt-2 py-2 text-white rounded-lg flex justify-center items-center ${
        loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-500 hover:bg-green-600 active:bg-green-600 focus:bg-green-600'
      }`}
    >
      {loading ? (
        <svg
...
<div className='flex justify-center items-center gap-5 p-2'>
  <div><HiBuildingOffice2  className='text-3xl text-gray-700'/>
  </div>
<div className='flex flex-col'> 
  <h1 className='text-xl font-semibold'>Kataria Software Solutions,
  </h1>
   <p className='text-gray-500'>Gurugram 68, near Bakshi Farms, Sohna, Haryana 122102</p>
   </div>
   </div>
<div className='flex justify-center items-center gap-5 p-2'>
  <div>
...
<div className='flex flex-col'> 
  <h1 className='text-xl font-semibold'>+91 9694395555  </h1> 
<p className='text-gray-500'>Mon to Sat 9am to 6pm</p>
</div>
</div>

<div className='flex justify-center items-center gap-5 p-2'>
  <div><IoIosMail className='text-3xl text-orange-500'/></div>
<div className='flex flex-col'> 
  <h1 className='text-xl font-semibold'>support@mykcs.in</h1> 
