...
const Products = () => {
  return (
    <div id="our-product" data-scroll data-scroll-section data-scroll-speed="-.2" className="rounded-b-xl w-full md:h-[135vh] h-[60vh] bg-zinc-900  md:px-20 px-2 flex flex-col">
      ...
      <div className=" flex items-center gap-5 overflow-x-scroll hide-scrollbar w-full">
        ...
        <div className=" cardcontainer flex gap-5 w-[700px] md:w-[600px] md:max-w-1/2 md:h-[50vh] h-[30vh]">
          <div className="card md:w-[300px] md:max-w-full w-[350px] h-full rounded-xl flex justify-center items-center bg-[#192826] relative">
            <div className="cursor-pointer hover:bg-[#CDEA68] hover:text-[#004d43] 
            absolute bottom-2 border-[1px] border-[#CDEA68] left-2 text-[#CDEA68] rounded-3xl px-3">&copy; 2017</div>
