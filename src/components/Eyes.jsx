...
useEffect(() => {
  ...
  return (
    <div className=" eyes w-full h-[70vh] md:h-screen overflow-hidden ">
      ...
      <div className="-mt-33 md:-mt-0 z-99  text-3xl md:text-5xl text-center md:pt-20 pt-40 neue-montreal text-bold text-[#CDEA68]" >Feel Free To Contact Us</div>
